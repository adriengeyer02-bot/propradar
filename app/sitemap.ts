...
const staticRoutes = [
  ...
  { path: '/guides', priority: 0.93, lastModified: '2026-07-13' },
  ...
  { path: '/regles', priority: 0.82, lastModified: '2026-07-13' },
...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    ...propFirms.map((firm) => ({
      ...
      lastModified: new Date(getFirmContentLastModified(firm.slug, firm.lastReviewed)),
