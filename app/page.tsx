...
export default function HomePage() {
  ...
  const legalWatchCount = propFirms.filter(
    (firm) => !firm.legalVerified || firm.regulatoryAudit.riskLevel === 'High' || firm.regulatoryAudit.riskLevel === 'Critical' || firm.regulatoryAudit.riskLevel === 'To audit'
  ).length;
  ...
  const dataUpdatedAt = '2026-07-10';
    ...
    <main>
      <section className="container hero home-hero">
        <div className="hero-copy">
          ...
          <div className="data-freshness">
            ...
            <small>{propFirms.length} firms, {officialSourceCount} source links, {legalMappedCount} legal files mapped.</small>
          </div>
        </div>
        ...
        <div className="hero-board">
          ...
          <div className="hero-proof-strip">
            <span>{legalMappedCount} legal entities mapped</span>
            <span>{officialSourceCount} saved source links</span>
            <span>Affiliate links always disclosed</span>
          </div>
        </div>
      </section>
      ...
      <section className="container page-insight-strip" aria-label="Fast decision shortcuts">
        ...
        <Link href="/guides/prop-firm-legal-check">
          ...
          <strong>{legalWatchCount} watch</strong>
          <small>Entity, regulator and source-depth checks before checkout.</small>
        </Link>
      </section>
