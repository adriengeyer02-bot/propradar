    ...
    <main>
      <section className="container hero home-hero">
        <div className="hero-copy">
          ...
          <div className="actions">
            ...
            <Link href="/meilleures-prop-firms" className="btn">Voir le top fiable</Link>
          </div>
        </div>
        ...
        <div className="hero-board">
          ...
          <div className="radar-orbit" aria-hidden="true">
            ...
            <span className="radar-dot radar-dot-good" />
            <span className="radar-dot radar-dot-watch" />
            <span className="radar-dot radar-dot-risk" />
          </div>
      ...
      <section className="container section">
        ...
        <div className="guide-entry-grid">
          <Link href="/meilleures-prop-firms" className="guide-entry-card">
      ...
      <section className="container section">
        <div className="section-heading">
          <div>
            ...
            <h2>Les guides qui peuvent capter du trafic Google.</h2>
          </div>
