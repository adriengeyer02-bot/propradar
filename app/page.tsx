          ...
          {topFirms.slice(0, 3).map((firm) => (
            <Link href={`/firm/${firm.slug}`} className="card trust-leader-card" key={firm.slug}>
              ...
              <div className="trust-leader-scoreline">
                <span className={`badge ${firm.score >= 80 ? 'badge-score-excellent' : 'badge-score-good'}`}>{firm.score}/100</span>
      ...
      <section className="container section" id="radar-weekly">
        <div className="newsletter-panel">
          <div>
            ...
            <p className="muted">
              A weekly digest can highlight firms moving up or down, new promo codes, payout-watch changes and rule updates.
            </p>
          </div>
          <form className="newsletter-form" action="mailto:contact@propradar.tech" method="post" encType="text/plain" aria-label="Newsletter signup">
            ...
            <small>No spam: weekly signals, promo codes and payout-watch changes only.</small>
          </form>
        </div>
      </section>
