...
export default function HomePage() {
  ...
  const radarSignals = [
    ...
    { firm: reviewAlerts[0], label: 'Avis à pondérer', className: 'radar-dot-caution' },
    ...
    <main>
      ...
      <section className="container section">
        <div className="section-heading">
          <div>
            <div className="eyebrow">Guides décision</div>
            <h2>Quatre portes d'entrée pour choisir plus vite.</h2>
          </div>
        ...
        <div className="guide-entry-grid">
          <Link href="/meilleures-prop-firms" className="guide-entry-card guide-entry-primary">
            ...
            <small>Score, prix, payout, Trustpilot filtré et conflit commercial visibles ensemble.</small>
          </Link>
          <Link href="/risques-payout" className="guide-entry-card">
            <span>Payout Watch</span>
            <strong>Risques de retrait à vérifier</strong>
            <small>Retards, refus, incidents et signaux opérationnels avant de payer un challenge.</small>
          </Link>
          <Link href="/trustpilot-prop-firms" className="guide-entry-card">
            <span>Avis publics</span>
            <strong>Lire Trustpilot sans se faire piéger</strong>
            <small>La note brute est séparée du niveau de fiabilité estimé par PropRadar.</small>
          </Link>
        ...
        <div className="guide-entry-grid seo-guide-grid">
          {homepageGuides.map((guide) => (
            <Link href={`/guides/${guide.slug}`} className="guide-entry-card" key={guide.slug}>
              ...
              <small>{selectGuideFirms(guide, 12).length} firm(s) reliée(s)</small>
            </Link>
          ))}
        </div>
      </section>
