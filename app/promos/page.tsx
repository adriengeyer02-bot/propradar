...
export default function PromosPage() {
  ...
  const legalWatchDealCount = uniqueDealFirms.filter(isLegalWatchFirm).length;
    ...
    <main className="container promos-page">
      ...
      <section className="page-insight-strip" aria-label="Deal safety summary">
        ...
        <Link href="#all-offers">
          <span>Ranked offers</span>
          <strong>{bestPromoDeals.length}</strong>
          <small>Codes and affiliate links remain clearly labelled.</small>
        </Link>
        <Link href="/audit">
        ...
        <Link href="/risques-payout">
          ...
          <strong>{legalWatchDealCount}</strong>
          <small>Legal/source watch signals among promoted firms.</small>
        </Link>
