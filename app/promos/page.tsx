...
export const metadata: Metadata = {
  title: 'Best prop firm deals, promo codes and current offers',
  description:
    'Commercial but cautious radar for prop firm promo codes: Apex SAVENOW, Blue Guardian, MyFundedFutures BUILDER, FunderPro PROPRADAR, The5ers 1EIJ6PO, FundedNext and Topstep.',
};
    ...
    <main className="container promos-page">
      <section className="promos-hero">
        <div>
          ...
          <p className="lead">
            PropRadar highlights discounts that can actually matter: promo code, entry price, transparent affiliate link,
      ...
      <section className="section">
        <div className="section-heading">
          <div>
            ...
            <h2>Evaluations worth comparing even without a promo code.</h2>
          </div>
        </div>
      ...
      <section className="section">
        <div className="section-heading">
          <div>
            <div className="eyebrow">Prop firm promo code FAQ</div>
