    ...
    <main className="container comparator-page">
      <section className="comparator-hero">
        <div className="comparator-title">
          ...
          <p className="lead">Produits, risques, signaux Reddit, fiabilité Trustpilot et incidents payout.</p>
        </div>
        ...
        <div className="comparator-stats">
          ...
          <div className="summary-score">
            ...
            <a href="#tableau" className="btn btn-primary">Explorer</a>
          </div>
        </div>
      </section>
      ...
      <section className="signal-dashboard" aria-label="Signaux prioritaires">
        ...
        <article className="signal-dashboard-card">
          <div className="signal-card-header">
            <div>
      ...
      <section className="panel comparator-panel" id="tableau">
        ...
        <div className="table-actions">
          <div>
            ...
            <span>
              ...
              Tous les signaux restent visibles sans défilement horizontal.
            </span>
          </div>
        ...
        <div className="firm-results-list">
          {filteredFirms.length === 0 ? (
            ...
            <article key={firm.slug} className={`firm-result-card ${index === 0 ? 'firm-result-featured' : ''}`}>
              ...
              <div className="firm-result-metrics">
                ...
                <div className="result-metric"><span>Produit</span><strong>{firm.products[0]?.name ?? 'Aucun produit actif'}</strong></div>
              </div>
