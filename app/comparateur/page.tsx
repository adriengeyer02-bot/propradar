...
const PAGE_SIZE = 20;
const DATA_UPDATED_AT = '2026-07-10';
...
export default function Comparateur() {
  ...
  const activeFilterCount = [search, status !== 'Tous', market !== 'Tous', scoreMin !== 'Tous', priceMax !== 'Tous', drawdown !== 'Tous', legalFilter !== 'Tous'].filter(Boolean).length;
    ...
    <main className="container comparator-page">
      ...
      <section className="panel comparator-panel" id="tableau">
        ...
        <div className="filter-bar">
          <label className="sr-only" htmlFor="comparator-search">Search prop firms</label>
          <input
            id="comparator-search"
            type="search"
            placeholder="Search by firm or trading style"
            value={search}
        ...
        <div className="table-actions" aria-live="polite">
          <div>
            ...
            <span>
              ...
              Showing {visibleStart}-{visibleEnd}. Filters update instantly.
            </span>
          </div>
