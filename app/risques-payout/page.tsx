...
export const metadata: Metadata = {
  title: 'Prop firm payout risks and withdrawal red flags',
  description:
    'Radar for prop firm payout risks: delays, denials, incidents, source depth, legal checks, public ratings to weigh and caution signals before buying.',
  alternates: {
