...
export const metadata: Metadata = {
  ...
  description:
    'Radar des risques payout prop firms : retards, refus, incidents, notes publiques à pondérer et signaux de prudence avant achat.',
  alternates: {
    ...
    <main className="container guide-page">
      <section className="guide-hero">
        <div>
          ...
          <h1>Prop firms : risques payout à vérifier avant achat</h1>
          <p className="lead">
            Les problèmes de retrait coûtent plus cher qu'une réduction ratée. Cette page isole les firms où le risque
        ...
        <div className="guide-proof-panel">
          <div><strong>{risky.length}</strong><span>firms affichées en surveillance</span></div>
          <div><strong>{criticalCount}</strong><span>risques critiques</span></div>
          <div><strong>{elevatedCount}</strong><span>risques élevés</span></div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="section-heading">
          <div>
            ...
            <h2>Les dossiers à lire deux fois</h2>
          </div>
        </div>
