    ...
    <main className="container guide-page seo-page">
      ...
      <section className="guide-hero">
        <div>
          ...
          <h1>Guides prop firms basés sur ce que les traders recherchent.</h1>
          <p className="lead">
            PropRadar transforme les grandes intentions de recherche en pages utiles : choix d'une firm, règles,
        ...
        <div className="guide-proof-panel">
          ...
          <div><strong>{propFirms.length}</strong><span>firms reliées aux guides</span></div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="section-heading">
          <div>
            ...
            <h2>Les recherches à capter en priorité.</h2>
          </div>
          <p className="section-note">Recherche structurée le {SEO_RESEARCH_DATE}. Les pages se recalculent avec la base PropRadar.</p>
        </div>
      ...
      <section className="section">
        <div className="section-heading">
          <div>
            ...
            <h2>Guides créés pour les recherches longues.</h2>
          </div>
        </div>
          ...
          {seoGuides.map((guide) => {
            ...
            return (
              <Link href={`/guides/${guide.slug}`} className="guide-entry-card" key={guide.slug}>
                ...
                <small>{firmCount} firm(s) reliée(s)</small>
              </Link>
            );
          })}
        </div>
      ...
      <section className="section">
        <div className="panel seo-update-panel">
          <div>
            ...
            <p className="lead">
              Chaque guide utilise les fiches firms, les produits, les règles, les signaux payout et les sources
              déjà présentes. Ajouter ou corriger une firm met à jour les guides concernés et le sitemap.
            </p>
          </div>
