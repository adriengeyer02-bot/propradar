...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const modifiedTime = new Date(getFirmContentLastModified(firm.slug, firm.lastReviewed)).toISOString();
...
export default async function FirmPage({ params }: Props) {
  ...
  const contentLastModified = getFirmContentLastModified(firm.slug, firm.lastReviewed);
