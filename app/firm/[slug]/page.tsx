    ...
    <main>
        ...
        <div className="panel firm-hero">
          <div>
            <div className="firm-cell" style={{ marginBottom: 18 }}>
              {firm.logoDomain ? (
                <img src={`https://logo.clearbit.com/${firm.logoDomain}?size=128`} alt="" className="logo" style={{ width: 58, height: 58 }} />
              ) : (
                <span className="logo fallback-logo" style={{ width: 58, height: 58 }}>{firm.name.slice(0, 2)}</span>
              )}
              <div>
          ...
          <div className="card" style={{ textAlign: 'center' }}>
            ...
            <div style={{ marginTop: 12 }}>
              <span className={`badge ${relationshipClass(firm.commercialRelationship)}`}>{firm.commercialRelationship}</span>
            </div>
          </div>
        </div>
      ...
      <section className="container section">
        ...
        <div className="grid-3">
          ...
          <div className="card">
            <div className="muted">Fiabilité Trustpilot</div>
          ...
          <div className="card">
            ...
            <p className="muted" style={{ marginTop: 12, marginBottom: 0 }}>
              Plus ce score est haut, plus les retards, refus, règles de retrait ou alertes opérationnelles pèsent lourd.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container section">
        <div className="grid-2">
          ...
          <div className="panel">
            <div className="eyebrow">À vérifier avant achat</div>
            <h2>Faiblesses</h2>
            <ul className="risk-list">
            ...
            {firm.products.map((product) => (
              <article className="card product-card" key={product.id}>
                ...
                <div className="stat-strip" style={{ gridTemplateColumns: 'repeat(2, minmax(0, 1fr))' }}>
                  ...
                  <div className="stat"><span>Frais</span><strong>{product.entryFeeMin ? `${formatUsd(product.entryFeeMin)}+` : 'Variable'}</strong></div>
                ...
                {product.linkToStart ? (
                  <a href={product.linkToStart} target="_blank" rel="noreferrer" className="btn btn-primary">
