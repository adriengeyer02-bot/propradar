...
import LiveCommunitySignals from '../../components/LiveCommunitySignals';
import {
  FTMO_AFFILIATE_URL,
  auditStatusClass,
  formatUsd,
...
function scoreProofRows(firm: PropFirm, kind: 'reddit' | 'x' | 'trustpilot' | 'payout' | 'manipulation'): ScoreProofRow[] {
  ...
  if (kind === 'x') {
    return [
      { label: 'Source', value: firm.reviewSignals.xSource === 'Estimation PropRadar' ? 'Estimation PropRadar, API X non synchronisée' : firm.reviewSignals.xSource ?? 'À documenter' },
      { label: 'Échantillon', value: `${firm.reviewSignals.xSampleSize ?? 0} mention(s) suivie(s)` },
    ...
    <main>
      ...
      <section className="container section" id="audit">
        ...
        <div className="grid-3">
          ...
          <div className="card">
            <div className="muted">X/Twitter score estimé</div>
            ...
            {firm.reviewSignals.xSource === 'Estimation PropRadar' ? <span className="badge badge-amber">Non live</span> : null}
            <div className="sentiment-breakdown">
            ...
            {firm.reviewSignals.xSource === 'Estimation PropRadar' ? (
              <p className="muted" style={{ marginTop: 8, marginBottom: 0 }}>
                Ce score n'est pas issu d'un crawl complet de X. Il devient live uniquement quand le bloc API ci-dessous affiche API active.
              </p>
            ) : null}
            <div className="score-proof">
        ...
        <LiveCommunitySignals slug={firm.slug} />
