...
function scoreProofRows(firm: PropFirm, kind: 'reddit' | 'x' | 'trustpilot' | 'payout' | 'manipulation'): ScoreProofRow[] {
  ...
  if (kind === 'x') {
    return [
      { label: 'Source', value: firm.reviewSignals.xSource === 'Estimation PropRadar' ? 'Estimation PropRadar, requêtes X à connecter' : firm.reviewSignals.xSource ?? 'À documenter' },
    ...
    <main>
      ...
      <section className="container section" id="audit">
        ...
        <div className="grid-3">
          ...
          <div className="card">
            <div className="muted">X/Twitter score</div>
            ...
            {firm.reviewSignals.xSource === 'Estimation PropRadar' ? <span className="badge badge-amber">Score estimé</span> : null}
            <div className="sentiment-breakdown">
