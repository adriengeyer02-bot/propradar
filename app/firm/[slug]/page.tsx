      ...
      <section className="container section">
        ...
        <div className="signal-explain-grid">
          ...
          <div className="signal-explain-card">
            ...
            <span className={`badge ${(firm.reviewSignals.manipulationRisk ?? 'Moyen') === 'Faible' ? 'badge-green' : (firm.reviewSignals.manipulationRisk ?? 'Moyen') === 'Moyen' ? 'badge-amber' : 'badge-red'}`}>
