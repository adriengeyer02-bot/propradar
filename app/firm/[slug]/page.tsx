...
import { getFirmRelatedGuides, getSeoGuideDisplay } from '../../lib/seoGuides';
      ...
      <section className="container detail-header">
        ...
        <div className="panel firm-hero">
          ...
          <div className="card" style={{ textAlign: 'center' }}>
            ...
            <div className={`score-tile firm-hero-score ${scoreClass(firm.score)}`} aria-label={`PropRadar score ${firm.score} out of 100`}>
              <span>Score</span>
        ...
        <div className="stat-strip">
          ...
          <div className="stat"><span>Drawdown</span><strong>{toEnglishText(firm.drawdownType)}</strong></div>
          <div className="stat"><span>News trading</span><strong>{toEnglishText(firm.newsTrading)}</strong></div>
          <div className="stat"><span>Payout</span><strong>{toEnglishText(firm.payoutDelay)}</strong></div>
        </div>
