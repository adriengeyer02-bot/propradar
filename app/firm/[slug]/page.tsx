...
function scoreRingStyle(score: number) {
  ...
  return {
    background: `conic-gradient(${scoreColor(score)} ${safeScore * 3.6}deg, rgba(217, 228, 242, 0.92) 0deg)`,
  };
}
    ...
    <main>
      ...
      <section className="container detail-header">
        ...
        <div className="panel firm-hero">
          ...
          <div className="card firm-score-ring-card" style={{ textAlign: 'center' }}>
            ...
            <div className="firm-score-actions">
              <Link href="/#radar-weekly" className="btn btn-primary">Create alert</Link>
