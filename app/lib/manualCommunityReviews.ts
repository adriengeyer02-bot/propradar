...
function createResearchReadyReview(firm: PropFirm): ManualCommunityReview {
  return {
    ...
    summary:
      'La collecte manuelle est préparée : les posts Reddit/X précis doivent encore être ouverts, classés et reliés à la fiche pour renforcer les scores bruts.',
    reddit: {
      coverage: 'Recherche prête',
      note:
    ...
    x: {
      coverage: 'Recherche prête',
      note:
        "Requête prête pour revue manuelle : seuls les posts publics ouverts manuellement doivent être comptés dans les avis positifs, négatifs et neutres.",
      sources: [
        {
