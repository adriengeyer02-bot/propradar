...
export const seoGuides: SeoGuide[] = [
  ...
  },
  {
    ...
    intent: 'comparer',
    demandSignal: 'Les requetes marque vs marque captent une intention d achat tres proche de la decision.',
    answer:
      'FTMO et The5ers sont des noms installes, mais le choix depend du style, du programme, des restrictions et du confort avec les regles de payout.',
  ...
  },
  {
    ...
    intent: 'comparer',
    demandSignal: 'Topstep vs Apex ressort naturellement des recherches futures prop firm.',
    answer:
      'Apex attire avec des promotions agressives, Topstep avec une image plus installee. Le bon choix depend du drawdown, des frais, des caps et de la confiance payout.',
