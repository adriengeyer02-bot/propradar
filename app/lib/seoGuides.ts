...
const guideDisplayOverrides: Record<string, SeoGuideDisplayOverride> = {
  'meilleure-prop-firm-2026': {
    ...
    metaDescription: 'Compare the best prop firms by score, payout risk, filtered Trustpilot, Reddit signal, rules, platforms and proof level.',
    eyebrow: 'Main ranking',
    h1: 'Best prop firm: the ranking starts with risk, not marketing',
    answer: 'The best prop firm is not simply the one with the biggest account size or the loudest discount. A useful choice starts with payout reliability, rule clarity, public feedback and the exact program you plan to buy.',
    ...
    checks: [
      'Compare payout risk before looking at account size.',
      'Check the exact program rules, not only the firm brand.',
      'Read filtered Trustpilot, Reddit and X/Twitter signals together.',
      'Separate affiliate links from the PropRadar score.',
    ],
    internalLinks: [
  ...
  'prop-firm-smc-ict': {
    title: 'Best prop firm for SMC / ICT',
    metaDescription: 'PropRadar guide for SMC and ICT traders: drawdown, sessions, news, payout, forex, futures and rules to avoid.',
    eyebrow: 'SMC / ICT style',
    h1: 'Prop firm for SMC / ICT: find flexibility without losing risk control',
    answer: 'For SMC and ICT trading, the right firm must let intraday setups breathe without unclear rules around news, drawdown, execution or payout validation.',
    primaryKeywords: ['SMC prop firm', 'ICT prop firm', 'best prop firm for SMC'],
    secondaryKeywords: ['day trading prop firm', 'forex prop firm', 'New York session', 'London session'],
    checks: [
      'Verify restrictions around London, New York and news.',
      'Avoid overly tight trailing drawdown if you scale entries.',
      'Compare spread, platform and execution.',
      'Check payout minimum if your strategy targets many smaller wins.',
    ],
    internalLinks: [
      { label: 'Trading style tool', href: '/outils' },
      { label: 'News trading', href: '/guides/prop-firm-news-trading' },
  ...
  'leveraged-prop-firm-avis': {
    ...
    metaDescription: 'Leveraged / Get Leveraged review: programs, 80% split, 5k to 1M accounts, overnight, payout, unavailable Trustpilot rating and points to verify.',
    eyebrow: 'Brand review',
    h1: 'Leveraged prop firm review: visible brand, but verify before buying',
    answer: 'Leveraged is an active prop firm with portfolio programs, accounts from 5k to 1M and an advertised 80% split. Before buying, verify the program rules, payout conditions and the Trustpilot alert that makes the public rating unavailable.',
    primaryKeywords: ['Leveraged prop firm review', 'Get Leveraged review', 'getleveraged.com Trustpilot'],
    secondaryKeywords: ['Leveraged payout', 'Leveraged rules', 'Portfolio Manager Simulation'],
    checks: [
      'Verify whether the chosen offer is Jr, Sr, Executive, Turbo, Crypto, Sprint or Classic.',
      'Read profit target, daily drawdown, max drawdown, overnight, weekend and payout frequency.',
      'Account for the Trustpilot alert: unavailable rating and removed reviews reported.',
  ...
  'prop-firm-sans-challenge': {
    ...
    metaDescription: 'No challenge prop firm: understand instant funding, direct accounts, fees, drawdown, payout and risks before paying more.',
    eyebrow: 'No challenge',
    h1: 'No challenge prop firm: the shortcut can cost more',
    answer: 'A no-challenge prop firm mainly sells time. It can suit an already stable trader, but it can be risky for a beginner who has not tested discipline under strict rules.',
    ...
    checks: [
      'Compare the direct account price with a classic challenge.',
      'Verify whether payout rules are stricter than on a normal evaluation.',
      'Look at real max loss before the first withdrawal.',
      'Avoid this format if you do not have a stable trading history yet.',
    ],
    internalLinks: [
      { label: 'Instant funding', href: '/guides/prop-firm-instant-funding' },
      { label: 'Trading style tool', href: '/outils' },
