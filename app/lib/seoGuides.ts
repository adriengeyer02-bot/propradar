...
export const SEO_RESEARCH_DATE = '2026-07-13';
...
export const seoGuides: SeoGuide[] = [
  ...
  },
  {
    ...
    metaDescription:
      'PropRadar guide to futures prop firms: Topstep, Apex, Take Profit Trader, MyFundedFutures, drawdown, payout and fees.',
  ...
  },
  {
    ...
    metaDescription:
      'Find a cheap prop firm without ignoring risk: minimum price, discount codes, payout, drawdown and funded-stage fees.',
  ...
  },
  {
    ...
    metaDescription:
      'Guide to prop firms for swing trading: overnight positions, weekend holding, news, drawdown, payout and holding rules.',
  ...
  },
  {
    ...
    metaDescription:
      'Which prop firms allow EAs, bots or algo trading? PropRadar guide to restrictions, VPS, copy trading, news and payout.',
    eyebrow: 'EA / Algo',
  ...
  },
  {
    ...
    metaDescription:
      'FTMO vs The5ers: compare score, price, rules, payout, Trustpilot, trading style, main programs and official links.',
  ...
  },
  {
    ...
    metaDescription:
      'FunderPro vs The5ers comparison: FunderPro PROPRADAR code, The5ers coupon 1EIJ6PO, news trading, EA, swing option, price, score and payout.',
  ...
  },
  {
    ...
    focusFirmSlugs: ['instant-funding', 'fxify', 'funded-trading-plus', 'aqua-funded', 'goat-funded-trader', 'audacity-capital', 'tradeify', 'blue-guardian'],
  },
  {
...
const guideDisplayOverrides: Record<string, SeoGuideDisplayOverride> = {
  ...
  'prop-firm-sans-consistency-rule': {
    title: 'Prop Firm Consistency Rule: Meaning & No-Rule Firms',
    metaDescription: 'What is a consistency rule in a prop firm? Learn the formula, payout impact and how to compare prop firms without consistency rules.',
    eyebrow: 'Rules search',
  ...
  'topstep-vs-apex': {
    title: 'Topstep vs Apex 2026: Payout, Drawdown & Total Cost',
    metaDescription: 'Topstep vs Apex Trader Funding comparison: payout rules, trailing drawdown, monthly and activation costs, platforms, discounts and risk signals.',
    eyebrow: 'Futures comparison',
  ...
  'goat-funded-trader-avis': {
    title: 'Goat Funded Trader Review: Rules, Payouts and Risk',
    metaDescription: 'Goat Funded Trader review: compare 1-step, 2-step, 3-step and Instant rules, news trading, weekend holding, payout terms and key risks.',
    eyebrow: 'Brand review',
    h1: 'Goat Funded Trader review: strong offer, but reread the rules before buying',
  ...
  'prop-firm-sans-challenge': {
    title: 'No-Challenge Prop Firms: Direct Funding Compared',
    metaDescription: 'Compare no-challenge prop firms and direct funded accounts by price, drawdown, payout reliability, consistency rules and true funded-stage cost.',
    eyebrow: 'No challenge',
