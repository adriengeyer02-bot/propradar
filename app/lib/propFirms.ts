...
const universePropFirms: PropFirm[] = [
  ...
  universeFirm({
    ...
    auditStatus: 'Partiellement vérifié',
    auditSummary:
      'Closure evidence rechecked July 15, 2026. Finance Magnates and FX News Group documented Skilled Funded Traders suspending operations and new purchases on March 28, 2024. The exact Easton-linked contracting structure and the final treatment of trader payouts or refunds still require archived primary documents.',
