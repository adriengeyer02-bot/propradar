...
const universePropFirms: PropFirm[] = [
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'Official homepage review returned only an unexpected single-line page/image referencing Tx3Funding branding during the July 8, 2026 PropRadar pass. Treat TopTier Trader as unresolved until current operator, brand migration status, terms, entity and payout obligations are confirmed from primary sources.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
      summary:
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'Official homepage returned no usable text during the July 8, 2026 PropRadar pass, and exact-name searches did not surface a reliable current prop-firm legal source. Legal entity, jurisdiction, terms, refund clauses and simulated-account disclosures remain unverified from primary sources.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
      summary:
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'Official site and exact-name searches did not return a usable primary legal page during the July 8, 2026 PropRadar pass. Legal entity, terms, refund clauses, broker/FCM relationships and simulated/live account disclosures remain unverified from primary sources.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
      summary:
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'Official site and likely legal URLs did not return usable primary legal text during the July 8, 2026 PropRadar pass. Legal entity, jurisdiction, terms, refund policy, simulated-account language and regulator/public-warning checks remain unverified from primary sources.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
      summary:
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'Official-looking domain returned an internal error during the July 8, 2026 PropRadar pass. No primary legal entity, terms or simulated-trading disclaimer could be captured.',
    regulatoryAudit: {
      riskLevel: 'To audit',
      lastChecked: '2026-07-08',
      summary: 'Legal audit pending because no usable official legal text was captured.',
      ...
      redFlags: ['Official-looking domain was not accessible in the web capture.', 'Do not rank as verified until legal pages are sourced.'],
      sources: [
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'Official-looking domain returned an internal error during the July 8, 2026 PropRadar pass. Legal entity, terms, refund policy and current activity remain unverified.',
    regulatoryAudit: {
      riskLevel: 'To audit',
      lastChecked: '2026-07-08',
      summary: 'Legal audit pending because no usable primary legal page was captured.',
      ...
      redFlags: ['Official-looking domain inaccessible in capture.', 'No entity or terms available from this pass.'],
      sources: [
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'Official-looking domain redirected to pro.tradingcult.com but no usable legal text was captured during the July 8, 2026 pass. Entity, terms and refund rules remain unverified.',
    regulatoryAudit: {
      riskLevel: 'To audit',
      lastChecked: '2026-07-08',
      summary: 'Legal audit pending because the captured page did not expose usable terms or legal disclosures.',
      ...
      redFlags: ['Redirected site provided no usable captured legal text.', 'Do not treat as legally verified until terms are sourced.'],
      sources: [
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'Official-looking domain returned an internal error during the July 8, 2026 PropRadar pass. Legal entity, terms, refund rules and operating status remain unverified.',
    regulatoryAudit: {
      riskLevel: 'To audit',
      lastChecked: '2026-07-08',
      summary: 'Legal audit pending because no usable official legal text was captured.',
      ...
      redFlags: ['Official-looking domain inaccessible in capture.', 'No legal pages sourced in this pass.'],
      sources: [
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'No usable official legal page was captured during the July 8, 2026 pass. The likely domain mycryptofunding.com did not return a verifiable terms/entity disclosure in this environment. Treat the listing as stale or unverified until the current official domain, entity and terms are confirmed.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'Official-looking domain did not expose usable legal text during the July 8, 2026 pass. No primary entity, terms, refund policy or operating-status proof was captured.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
      ...
      redFlags: ['No usable primary legal source captured.', 'Do not rank as active/verified without fresh source material.'],
      sources: [
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'The likely official domain redirects to optimal-traders.com and returns the title "Optimal Traders - World\'s Most Powerful Prop Firm", but no readable legal/entity text was captured. Treat the fiche as unverified until Terms, refund rules and entity details are accessible.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
      ...
      redFlags: ['Readable page title but no captured legal content.', 'Strong superlative title without visible legal backing in this pass.'],
      sources: [
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'No usable official website or legal page was captured during this pass. The listed domain needs manual confirmation because PropRadar could not verify entity, jurisdiction, terms, refund policy or live operating status.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
      ...
      redFlags: ['No usable primary source captured.', 'Do not recommend until the active domain and terms are verified.'],
      sources: [
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'No usable current official legal source was captured for the listed domain during the July 8, 2026 pass. This name may require domain-history research because the operator, terms and refund rules are not verified.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
      ...
      redFlags: ['No usable official legal page captured.', 'Potentially stale or ambiguous name/domain match.'],
      sources: [
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'No current official prop-firm website, legal entity, terms page or refund policy was captured during the July 8, 2026 pass. The CK Capital name is too ambiguous to treat as verified without a current official URL.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
      ...
      redFlags: ['Ambiguous brand name.', 'No usable primary legal source captured.', 'Do not recommend until official terms are sourced.'],
      sources: [
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'No usable official legal page was captured for the likely domain firmityfunding.com during this pass. Entity, operating status, terms, refund policy and payout rules remain unverified.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
      ...
      redFlags: ['Likely official domain did not expose usable legal text.', 'No terms, refund policy or entity disclosure captured.'],
      sources: [
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'Official-looking domain was reachable and presented Hash Hedge as a crypto prop-firm brand, but the captured page exposed no readable terms, entity disclosure, refund policy or broker/non-broker disclaimer. Keep as high-information-risk until legal pages are accessible.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'No usable official website, legal text or current operating proof was captured for Real Funds Trader during the July 8, 2026 pass. The entry remains unverified and may be stale.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
      ...
      redFlags: ['No usable primary legal source captured.', 'Potentially stale or inactive domain match.'],
      sources: [
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'No usable official legal source was captured for The Prop Game during this pass. The name is too generic to verify without current official terms, entity and refund/payout policy.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
      ...
      redFlags: ['Generic name creates false-positive search risk.', 'No usable primary legal source captured.'],
      sources: [
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'No usable official website, legal entity, terms page or refund policy was captured during the July 8, 2026 pass. Searches for NEG Markets did not return a reliable prop-firm source in this environment.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
      ...
      regulatoryStatus: ['Official legal entity, broker status, terms and refund policy not confirmed.'],
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'Official-looking domain shows a maintenance page saying MT5 accounts and CRM are being shifted, then links to funding.fortressfx.com. The alternate site currently resolves to a Hostinger parked-domain page. Entity, terms, refund policy and active operating status are not verified.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'No usable official website, legal documents or operating-status proof was captured for Indigo Trader Funding. Treat as unverified until a current domain, entity and terms are sourced.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
      ...
      regulatoryStatus: ['Entity, jurisdiction, broker status and simulated-service wording not confirmed.'],
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'No usable official site, prop-firm offer, legal entity or terms page was captured for Stocknet Institute during this pass. The name may refer to education rather than an active prop-firm program.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
      ...
      regulatoryStatus: ['Legal entity, service model, terms and refund policy not confirmed.'],
  ...
  universeFirm({
    ...
    auditStatus: 'À auditer',
    auditSummary:
      'No usable official prop-firm site, legal entity, terms page or refund policy was captured for Willis Capital during the July 8, 2026 pass. Search results are dominated by unrelated Willis/WTW insurance and investment entities, so this entry carries a strong false-positive risk.',
    regulatoryAudit: {
      riskLevel: 'High',
      lastChecked: '2026-07-08',
      ...
      regulatoryStatus: ['Official legal entity, service model, broker status and simulated-service wording not confirmed.'],
      complaintsAndDisputes: ['Manual domain-history, Trustpilot and social review required before any ranking.'],
      redFlags: [
