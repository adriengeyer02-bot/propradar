...
const universePropFirms: PropFirm[] = [
  ...
  universeFirm({ id: 111, slug: 'lucid-trading', name: 'Lucid Trading', website: 'https://lucidtrading.com/', status: 'À surveiller', score: 61, founded: 2024, market: 'Futures', priceFrom: 99, styles: ['Futures'] }),
