...
const corePropFirms: PropFirm[] = [
  firm({
    ...
    products: [
      product({
        ...
        hasConsistencyRule: true,
        consistencyRule: 'FTMO applies a 50% Best Day Rule on the 1-Step path and FTMO Account. Confirm the exact stage and product before payout.',
    ...
    regulatoryAudit: {
      ...
      sources: [
        ...
        { label: 'FTMO news-trading FAQ', url: 'https://ftmo.com/faq/can-i-trade-news/' },
  ...
  firm({
    ...
    commercialRelationship: 'Affiliation transparente',
    commercialNote: 'PropRadar may receive a commission through the The5ers link. Coupon 1EIJ6PO remains a checkout test with no public percentage confirmed on 13 July 2026; any real reduction must appear in the subtotal and has no impact on the score.',
    products: [
      product({
        ...
        consistencyRule: 'No percentage best-day rule is captured for High Stakes; The5ers Futures uses a separate per-position consistency rule.',
    ...
    auditStatus: 'Vérifié multi-source',
    auditSummary:
      'Official The5ers sources and Trustpilot page checked. High Stakes and the current Futures program must be separated: the Futures page advertises news trading as allowed and applies a per-position consistency rule.',
    auditSourcesChecked: ['Official site', 'Official programs', 'The5ers Futures rules', 'Trustpilot', 'Payout/community signals'],
    regulatoryAudit: {
      riskLevel: 'Low to medium',
      lastChecked: '2026-07-06',
      summary:
      ...
      sources: [
        ...
        { label: 'The5ers Futures program and news-trading status', url: 'https://www.the5ers.com/futures/' },
  ...
  firm({
    ...
    newsTrading: 'Variable',
    eaAllowed: 'Variable',
    payoutDelay: 'path- and account-specific after eligibility',
    incidents: 1,
    transparencyScore: 17,
    payoutProof: true,
    recentRuleChange: true,
    ...
    products: [
      product({
        ...
        description: 'Futures evaluation with a 50% Trading Combine consistency target and a transition to path-specific Express Funded Account payout rules.',
        accountSizeMin: 50000,
        accountSizeMax: 150000,
        entryFeeMin: 49,
        entryFeeMax: 149,
        maxDrawdown: 'trailing',
        profitSplit: 'path- and account-cohort-specific',
        platforms: ['TopstepX', 'NinjaTrader', 'Tradovate'],
        tradableAssets: ['Futures'],
        hasConsistencyRule: true,
        consistencyRule: 'Trading Combine uses a 50% consistency target. Express Funded Account rules depend on the Standard or Consistency payout path.',
    ...
    auditStatus: 'Partiellement vérifié',
    auditSummary:
      'Official rules rechecked July 15, 2026. The Trading Combine uses a 50% consistency target; Express Funded Account Standard and Consistency paths use different payout qualification rules. Payout eligibility, caps and split can also depend on the account cohort.',
    auditSourcesChecked: ['Official site', 'Trading Combine parameters', 'Express Funded Account parameters', 'Official payout policy', 'Trustpilot'],
    regulatoryAudit: {
      riskLevel: 'Medium to high',
      ...
      sources: [
        ...
        { label: 'Topstep consistency rules', url: 'https://help.topstep.com/en/articles/8284208-consistency-at-topstep' },
        { label: 'Topstep payout policy', url: 'https://help.topstep.com/en/articles/8284233-topstep-payout-policy' },
        { label: 'Topstep Trading Combine parameters', url: 'https://help.topstep.com/en/articles/8284197-trading-combine-parameters' },
        { label: 'Topstep Express Funded Account parameters', url: 'https://help.topstep.com/en/articles/8284215-express-funded-account-parameters' },
  ...
  firm({
    ...
    newsTrading: 'Variable',
    eaAllowed: 'Variable',
    payoutDelay: 'account-version and eligibility dependent',
    incidents: 3,
    ...
    reviewSignals: {
      ...
      lastSignalCheck: '2026-07-15',
    },
    products: [
      product({
        id: 'apex-evaluation',
        name: 'EOD Evaluation Account',
        type: 'Futures evaluation',
        description: 'Newer futures evaluation track with EOD drawdown behavior; funded-stage consistency and payout eligibility still apply.',
        accountSizeMin: 25000,
        accountSizeMax: 300000,
        entryFeeMin: 37,
        entryFeeMax: 657,
        maxDailyLoss: 'specific futures rules',
        maxDrawdown: 'EOD trailing drawdown',
        profitSplit: '100% of approved payouts advertised',
        platforms: ['NinjaTrader', 'Tradovate', 'Rithmic'],
        tradableAssets: ['Futures'],
        consistencyRule: 'New evaluations advertise no consistency rule; new Performance Accounts advertise 50% consistency. Legacy rules differ.',
        linkToStart: 'https://apextraderfunding.com/',
        isPopular: true,
      }),
      product({
        id: 'apex-intraday-evaluation',
        name: 'Intraday Trailing Evaluation Account',
        type: 'Futures evaluation',
        description: 'Newer futures evaluation track with intraday trailing drawdown; do not compare it as if it were the EOD or legacy product.',
        accountSizeMin: 25000,
        accountSizeMax: 300000,
        entryFeeMin: 37,
        entryFeeMax: 657,
        maxDailyLoss: 'account-specific rules',
        maxDrawdown: 'intraday trailing drawdown',
        profitSplit: '100% of approved payouts advertised',
        platforms: ['NinjaTrader', 'Tradovate', 'Rithmic'],
        tradableAssets: ['Futures'],
        consistencyRule: 'New evaluations advertise no consistency rule; new Performance Accounts advertise 50% consistency. Legacy rules differ.',
    ...
    regulatoryAudit: {
      ...
      sources: [
        ...
        { label: 'Apex EOD Performance Account rules', url: 'https://apextraderfunding.com/help-center/eod-trailing-drawdown-accounts/eod-performance-accounts-pa/' },
        { label: 'Apex Intraday Performance Account rules', url: 'https://apextraderfunding.com/help-center/intraday-trailing-drawdown-accounts/intraday-trailing-drawdown-performance-accounts-pa/' },
        { label: 'Apex legacy payout parameters', url: 'https://apextraderfunding.com/help-center/legacy-payouts/legacy-pa-payout-parameters/' },
        { label: 'FCA warnings page', url: 'https://www.fca.org.uk/news/warnings' },
      ],
    },
    sources: [
  ...
  firm({
    ...
    products: [
      product({
        ...
        tradableAssets: ['Forex', 'Indices', 'Metals', 'Crypto'],
        hasConsistencyRule: false,
        consistencyRule: 'Standard 1-Step, 2-Step and 3-Step cards currently display no consistency score. Instant and Buy Now, Pay Later products can use a consistency score.',
  ...
  firm({
    ...
    commercialRelationship: 'Affiliation transparente',
    commercialNote:
      'PropRadar may receive a commission through the GOAT Funded Trader link. Official codes FIRSTGFT and BOGO40 were checked on 13 July 2026; eligibility and the final checkout reduction remain program-dependent and do not affect the score.',
    products: [
      product({
        id: 'goat-challenges',
    ...
    strengths: ['News trading advertised', 'Weekend holding advertised', '1-step, 2-step, 3-step and Instant programs', 'Current official codes documented'],
  ...
  firm({
    ...
    products: [
      product({
        ...
        tradableAssets: ['Forex', 'Indices', 'Commodities'],
        hasConsistencyRule: false,
        consistencyRule: 'BrightFunded states that it does not currently enforce a consistency rule.',
        linkToStart: 'https://brightfunded.com/',
      }),
    ],
    auditStatus: 'Partiellement vérifié',
    auditSummary:
      'Official homepage, Terms, consistency and news-rule help pages checked. BrightFunded states that evaluation-stage news trading is allowed, while funded accounts restrict execution from five minutes before to five minutes after selected events. The official help center currently states that BrightFunded does not enforce a consistency rule.',
    auditSourcesChecked: ['Official homepage', 'Terms and Conditions', 'Official consistency-rule help page', 'Official news-trading help page', 'Trustpilot/review links'],
    regulatoryAudit: {
      riskLevel: 'Medium',
      lastChecked: '2026-07-08',
      summary:
      ...
      sources: [
        ...
        { label: 'BrightFunded consistency-rule help page', url: 'https://help.brightfunded.com/en/articles/12577176-does-brightfunded-have-a-consistency-rule' },
        { label: 'BrightFunded news-trading help page', url: 'https://help.brightfunded.com/en/articles/9241694-can-i-trade-news' },
  ...
  firm({
    ...
    products: [
      product({
        ...
        tradableAssets: ['Forex', 'Indices', 'Crypto'],
        hasConsistencyRule: true,
        consistencyRule: 'Current public pages and terms show plan-specific best-day rules, including 15% or 20% depending on the account. Verify the selected plan.',
        linkToStart: 'https://instantfunding.com/',
      }),
    ],
    sources: [
      { label: 'Official Instant Funding site', url: 'https://instantfunding.com/' },
      { label: 'Instant Funding June 2026 General Terms', url: 'https://instantfunding.com/wp-content/uploads/2026/06/Instant-Funding-General-Terms-Conditions.pdf' },
  ...
  firm({
    ...
    verdict: 'Visible offer, but the live checkout and main-site legal disclosures currently point to different operating entities.',
    priceFrom: 47,
    profitSplit: 80,
    drawdownType: 'Hybride',
    newsTrading: 'Variable',
    ...
    commercialRelationship: 'Affiliation transparente',
    commercialNote: 'PropRadar may receive a commission through the Blue Guardian link. Official checkout code LAUNCH displayed a 40% reduction on 13 July 2026; the cart subtotal must still be verified and the offer has no impact on the score.',
    products: [
      product({
    ...
    regulatoryAudit: {
      ...
      summary:
        'Medium-to-high legal risk. The main site identifies Blue Guardian Limited in Saint Lucia and Iconic Exchange FZCO in Dubai, but the live checkout Evaluation Terms identify Iconic Exchange Limited, company 12087566, as the operator. The official UK register records that company as dissolved on 6 May 2025. This may be stale checkout wording, but the contracting and invoicing entity must be resolved before payment.',
      entities: [
        {
        ...
        {
          name: 'Iconic Exchange Limited',
          jurisdiction: 'England and Wales',
          registrationNumber: '12087566',
          registeredAddress: '2 Highlands Court, Cranmore Avenue, Solihull, West Midlands, England, B90 4LE',
          role: 'Named as operator in the live checkout Evaluation Terms, while Companies House records the company as dissolved on 6 May 2025. The checkout wording may be stale and requires clarification before purchase.',
        },
      ],
      regulatoryStatus: [
        ...
        'No FCA, CySEC or equivalent investment-services authorization is documented in PropRadar for the prop-firm product.',
        'The main-site terms and live checkout terms do not currently identify the same operating entity.',
      ],
      complaintsAndDisputes: [
        ...
        'No major public regulatory enforcement action is documented in PropRadar at this check.',
        'The checkout names a UK company that the official register marks as dissolved; support should identify the current contracting and invoicing entity in writing.',
      ],
      redFlags: [
        'Entity mismatch between the main site and the live checkout contract wording.',
        'The UK company named by the checkout was dissolved on 6 May 2025 according to Companies House.',
      ...
      sources: [
        ...
        { label: 'Blue Guardian live checkout and Evaluation Terms', url: 'https://checkout.blueguardian.com/' },
        { label: 'UK Companies House: Iconic Exchange Limited 12087566', url: 'https://find-and-update.company-information.service.gov.uk/company/12087566' },
  ...
  firm({
    ...
    score: 77,
    founded: 2022,
    headquarters: 'Czech Republic / Japan',
    ...
    auditStatus: 'Vérifié multi-source',
    auditSummary:
      'Official 2026 privacy and provider-program documents, support pages, a Czech registry-derived company profile and Czech business-press coverage checked. The documents identify Fintokei a.s. and clearly describe simulated trading, but Fintokei\'s own current pages display two different company numbers: 09110127 in the 2026 legal documents versus 19325281 in the support footer. This unresolved identity mismatch must be checked against the invoice and contract before purchase.',
    auditSourcesChecked: ['Official site', '2026 Privacy Policy', 'Provider Program Terms', 'Official support footer', 'Czech registry-derived company profile', 'Hospodářské noviny company interview'],
    regulatoryAudit: {
      riskLevel: 'Medium',
      lastChecked: '2026-07-13',
      summary:
        'Medium legal risk despite unusually clear simulation disclaimers. Official 2026 legal documents and a Czech registry-derived profile support Fintokei a.s., company number 09110127, in Brno. However, the current official support footer displays a different number, 19325281, and a different register file. The discrepancy is material because the contracting entity must match the invoice, terms and payout route.',
      entities: [
        {
          name: 'Fintokei a.s.',
          jurisdiction: 'Czech Republic',
          registrationNumber: '09110127',
          registeredAddress: 'Masarykova 409/26, 602 00 Brno, Czech Republic',
          role: 'Company identified in the 2026 Privacy Policy and Provider Program Terms; a registry-derived profile reports register file B 8941.',
        },
        {
          name: 'AXSE Brokerage Ltd',
          jurisdiction: 'Seychelles',
          registrationNumber: '8424258-1',
          role: 'Platform and technical-infrastructure provider identified by Fintokei support; this does not make Fintokei accounts customer brokerage deposits.',
        },
      ],
      regulatoryStatus: [
        'The 2026 Privacy Policy and Provider Program Terms identify Fintokei a.s. under company number 09110127.',
        'Official support says accounts use virtual funds in a simulated environment and that Fintokei is not a broker or deposit taker.',
        'Official support identifies AXSE Brokerage Ltd in Seychelles as the platform and technical-infrastructure operator.',
        'A Czech registry-derived profile also maps Fintokei a.s. to company number 09110127 and reports prior names in its corporate history.',
        'Hospodářské noviny has published an interview with Fintokei CEO David Varga explaining the prop-trading model; this is company coverage, not regulatory approval.',
      ],
      complaintsAndDisputes: [
        ...
        'The legal entity and company number shown on the invoice, checkout and applicable program terms should be compared before payment.',
        'Program-specific refund, payout and dispute clauses still require a final check at checkout.',
      ],
      redFlags: [
        'Current official pages conflict on the Fintokei a.s. company number: 09110127 versus 19325281.',
      ...
      sources: [
        ...
        { label: 'Fintokei 2026 Privacy Policy', url: 'https://www.fintokei.com/wp-content/uploads/2026/06/05_2026_Privacy-Policy_EN_V5.pdf' },
        { label: 'Fintokei Provider Program Terms', url: 'https://www.fintokei.com/downloads/Fintokei_provider_program_TaC_ProTrader_FPP.pdf' },
        { label: 'Fintokei support: company and simulated-account disclosures', url: 'https://support.fintokei.com/en/collections/3622196-about-fintokei' },
        { label: 'Fintokei a.s. Czech registry-derived profile', url: 'https://www.finmag.cz/obchodni-rejstrik/09110127-fintokei-a-s' },
        { label: 'Hospodářské noviny interview with Fintokei CEO', url: 'https://hn.cz/c1-67860150-vydelat-na-burze-840-tisic-a-riskovat-pritom-jen-zlomek-svych-penez-tak-funguje-prop-trading-vysvetluje-ceo-fintokei-david-varga' },
      ],
    },
    sources: [
      { label: 'Official Fintokei site', url: 'https://www.fintokei.com/' },
      { label: 'Fintokei 2026 Privacy Policy', url: 'https://www.fintokei.com/wp-content/uploads/2026/06/05_2026_Privacy-Policy_EN_V5.pdf' },
      { label: 'Fintokei support disclosures', url: 'https://support.fintokei.com/en/collections/3622196-about-fintokei' },
      { label: 'Hospodářské noviny interview with Fintokei CEO', url: 'https://hn.cz/c1-67860150-vydelat-na-burze-840-tisic-a-riskovat-pritom-jen-zlomek-svych-penez-tak-funguje-prop-trading-vysvetluje-ceo-fintokei-david-varga' },
    ],
  }),
  firm({
    ...
    auditStatus: 'Vérifié multi-source',
    auditSummary:
      'Official legal disclosures, rules/help pages and industry-press coverage checked. Audacity Capital discloses a Dubai payment facilitator, a Comoros trading operator, a UK office and a Cyprus payment partner. Finance Magnates also documented a temporary pause in new US registrations in February 2024 during the MetaQuotes disruption. That report is historical and does not prove a current restriction, so present eligibility must still be confirmed.',
    auditSourcesChecked: ['Official site', 'Footer legal/compliance disclaimer', 'Terms and press pages', 'Official trading-rule help', 'Finance Magnates 2024 coverage', 'Trustpilot/Feefo badges'],
    regulatoryAudit: {
      riskLevel: 'Medium',
      lastChecked: '2026-07-13',
      summary:
      ...
      regulatoryStatus: [
        ...
        'Finance Magnates reported a temporary pause in new US registrations in February 2024 during the wider MetaQuotes/prop-firm disruption; existing users were reportedly unchanged.',
        'The 2024 US onboarding report is historical and must not be presented as proof of current eligibility.',
      ],
      complaintsAndDisputes: [
        ...
        'Current news-trading and prohibited-strategy rules vary by program and should be saved before trading.',
      ],
      redFlags: [
        ...
        'A historical onboarding restriction must be rechecked rather than assumed to remain active.',
      ],
      sources: [
        ...
        { label: 'Audacity Capital press and media page', url: 'https://audacity.capital/press-media/' },
        { label: 'Finance Magnates: 2024 US onboarding pause', url: 'https://www.financemagnates.com/forex/breaking-13-year-old-prop-trading-firm-suspends-us-client-onboarding/' },
        { label: 'Audacity Capital prohibited strategies', url: 'https://help.audacity.capital/hc/en-gb/articles/31929047154834-What-are-the-prohibited-strategies' },
      ],
    },
    sources: [
      { label: 'Official Audacity Capital site', url: 'https://audacity.capital/' },
      { label: 'Audacity Capital Terms and Conditions', url: 'https://www.audacity.capital/terms-and-conditions/' },
      { label: 'Finance Magnates: Audacity Capital US onboarding pause in 2024', url: 'https://www.financemagnates.com/forex/breaking-13-year-old-prop-trading-firm-suspends-us-client-onboarding/' },
    ],
  }),
  firm({
    id: 20,
    ...
    bestFor: 'forex and CFD traders comparing challenge and no-evaluation paths with an education layer',
    verdict: 'Long-running CFD evaluation brand with identifiable current terms, but its legal wording, broad risk discretion and simulated-versus-live marketing gap require a careful pre-purchase check.',
    priceFrom: 39,
    profitSplit: 100,
    drawdownType: 'Hybride',
    newsTrading: 'Allowed',
    eaAllowed: 'Variable',
    payoutDelay: 'On demand first; then monthly or bi-weekly',
    incidents: 1,
    incidentsDetails: [
      'September 2025 evaluation terms define all accounts as simulated demo accounts, while current Instant Funding sales pages use live-capital language.',
      'Finance Magnates reported trader complaints about account breaches under an overleveraging policy; CTI said the policy was disclosed in FAQs and welcome emails.',
      'The operating structure moved away from the former UK CTI company name and used Comoros and UAE entities across successive 2025 legal documents.',
    ],
    styles: ['Forex', 'Indices', 'Swing', 'Instant funding'],
    legalVerified: true,
    transparencyScore: 17,
    recentRuleChange: true,
    lastReviewed: '2026-07-15',
    ...
    communitySignal: 'Established since 2018 with 1,691 Trustpilot reviews at this check and recent financial-press coverage, but public feedback still includes rule-enforcement and payout-eligibility disputes.',
    products: [
      product({
        id: 'cti-one-step',
        name: 'CTI 1-Step Challenge',
        type: 'Challenge',
        description: 'Single-phase simulated evaluation with an 8% target and relative balance-based drawdown.',
        accountSizeMin: 2500,
        accountSizeMax: 200000,
        entryFeeMin: 59,
        profitTarget: '8%',
        maxDailyLoss: 'None listed on the official comparison table',
        maxDrawdown: '5% relative, balance-based',
        profitSplit: 'Up to 100% by progression tier',
        platforms: ['MT5', 'Match-Trader'],
        tradableAssets: ['Forex', 'Indices', 'Commodities', 'Crypto'],
        minTradingDays: '3 profitable days for the evaluation; payout conditions also apply',
        hasConsistencyRule: false,
        consistencyRule: 'No percentage consistency score listed; profitable-day and conduct rules still apply.',
        linkToStart: 'https://citytradersimperium.com/compare-funding-programs/',
      }),
      product({
        id: 'cti-two-step',
        name: 'CTI 2-Step Challenge',
        type: 'Challenge',
        description: 'Two-phase simulated evaluation with static balance-based loss limits and the lowest advertised entry price.',
        accountSizeMin: 2500,
        accountSizeMax: 200000,
        entryFeeMin: 39,
        profitTarget: '10% in phase 1, 5% in phase 2',
        maxDailyLoss: '5%',
        maxDrawdown: '10% static, balance-based',
        profitSplit: 'Up to 100% by progression tier',
        platforms: ['MT5', 'Match-Trader'],
        tradableAssets: ['Forex', 'Indices', 'Commodities', 'Crypto'],
        minTradingDays: '3 profitable days per evaluation phase; payout conditions also apply',
        hasConsistencyRule: false,
        consistencyRule: 'No percentage consistency score listed; profitable-day and conduct rules still apply.',
        linkToStart: 'https://citytradersimperium.com/compare-funding-programs/',
        isPopular: true,
      ...
      product({
        id: 'cti-instant',
        name: 'CTI Instant Funding',
        type: 'Instant funding',
        description: 'No-evaluation simulated account under CTI terms, marketed as immediate funded access with tiered rewards and scaling.',
        accountSizeMin: 2500,
        accountSizeMax: 80000,
        entryFeeMin: 79,
        profitTarget: '10% to scale',
        maxDailyLoss: 'None listed',
        maxDrawdown: '6% static, balance-based',
        profitSplit: '50% to 100% by level and VIP tier',
        platforms: ['MT5', 'Match-Trader'],
        tradableAssets: ['Forex', 'Indices', 'Commodities', 'Crypto'],
        minTradingDays: 'Payout eligibility varies; official pages describe profitable-day and minimum-profit conditions',
        hasConsistencyRule: false,
        consistencyRule: 'No percentage consistency score listed; payout qualification and conduct rules still apply.',
        linkToStart: 'https://citytradersimperium.com/forex-funded-trader-accounts/',
      }),
      product({
        id: 'cti-instant-pro',
        name: 'CTI Instant Funding Pro',
        type: 'Instant funding',
        description: 'Higher-priced no-evaluation simulated account with a higher initial reward split and on-demand first reward claim.',
        accountSizeMin: 5000,
        accountSizeMax: 160000,
        entryFeeMin: 229,
        profitTarget: '10% to scale',
        maxDailyLoss: 'None listed',
        maxDrawdown: '6% static, balance-based',
        profitSplit: '70% to 100% by level and VIP tier',
        platforms: ['MT5', 'Match-Trader'],
        tradableAssets: ['Forex', 'Indices', 'Commodities', 'Crypto'],
        minTradingDays: 'On-demand first reward claim; later bi-weekly subject to qualification rules',
        hasConsistencyRule: false,
        consistencyRule: 'No percentage consistency score listed; payout qualification and conduct rules still apply.',
        linkToStart: 'https://citytradersimperium.com/forex-funded-trader-accounts/',
      }),
    ...
    strengths: [
      'Operating brand active since 2018 with recent independent financial-press coverage',
      'Current evaluation terms identify CTI FZCO and state the governing law',
      'Four program paths with concrete published targets, drawdown types and platform choices',
      'Large current Trustpilot sample and an official payout-evidence library',
    ],
    weaknesses: [
      'Binding terms describe simulation while some current sales copy says live capital',
      'Broad unilateral discretion over prohibited methods, risk limits, suspension and termination',
      'Entity history spans a renamed UK company, a Comoros structure and the current UAE contracting entity',
      'Reward timing and split depend heavily on program, level, profitable days and VIP status',
    ],
    sources: [
      { label: 'City Traders Imperium official site and current program tables', url: 'https://citytradersimperium.com/' },
      { label: 'CTI September 2025 Evaluation Terms', url: 'https://citytradersimperium.com/wp-content/uploads/2025/09/CTI-FZCO-City-Traders-Imperium-Terms-Conditions.pdf' },
      { label: 'CTI funding-program comparison', url: 'https://citytradersimperium.com/compare-funding-programs/' },
      { label: 'Companies House filing history for former UK CTI company', url: 'https://find-and-update.company-information.service.gov.uk/company/11463147/filing-history' },
      { label: 'Finance Magnates on CTI Comoros entity and in-house MT5', url: 'https://www.financemagnates.com/forex/prop-firm-city-traders-imperium-opens-offshore-comoros-entity-to-launch-in-house-mt5/' },
      { label: 'Finance Magnates June 2026 CTI interview and complaint context', url: 'https://www.financemagnates.com/forex/some-of-them-wont-be-around-in-six-months-city-traders-imperium-ceo-says-of-cheaper-rivals/' },
      { label: 'Trustpilot City Traders Imperium', url: 'https://www.trustpilot.com/review/citytradersimperium.com' },
    ],
    auditStatus: 'Vérifié multi-source',
    auditSummary:
      'Deep legal and press pass completed. Current September 2025 terms identify CTI FZCO in Dubai as the contracting operator and classify every account as simulated. Earlier April 2025 terms named a Comoros company for simulated trading, while the former UK CTI company was renamed and entered a voluntary strike-off process. Program pages, Companies House, Trustpilot and two Finance Magnates investigations were cross-checked.',
    auditSourcesChecked: [
      'Current official site and program comparison',
      'September 2025 and April 2025 legal terms',
      'Companies House filing history',
      'Finance Magnates 2025 and 2026 coverage',
      'Trustpilot current profile and recent review sample',
    ],
    regulatoryAudit: {
      riskLevel: 'Medium to high',
      lastChecked: '2026-07-12',
      summary:
        'Medium-to-high legal and contractual risk. CTI has a longer operating history and better source coverage than many retail prop firms, but traders buy a UAE-governed educational/evaluation service using simulated accounts, not a protected brokerage deposit. Entity changes and broad discretionary enforcement remain material.',
      entities: [
        {
          name: 'CTI FZCO',
          jurisdiction: 'Dubai, United Arab Emirates',
          registrationNumber: 'DSO-FZCO-21340',
          registeredAddress: 'Dubai Silicon Oasis, DDP, Building A1, Dubai, United Arab Emirates',
          role: 'Current contracting entity and City Traders Imperium trade-name operator in the September 2025 Evaluation Terms.',
        },
        {
          name: 'City Traders Imperium',
          jurisdiction: 'Union of Comoros, Anjouan',
          registrationNumber: '15969',
          registeredAddress: 'Hamchako, Mutsamudu, Autonomous Island of Anjouan, Union of Comoros',
          role: 'Named as simulated-trading service provider in April 2025 terms and linked by Finance Magnates to the in-house MT5 launch; not named as the contracting company in the September 2025 terms.',
        },
        {
          name: 'Golden Trader Program Academy Limited',
          jurisdiction: 'England and Wales',
          registrationNumber: '11463147',
          registeredAddress: '124 City Road, London, EC1V 2NX, United Kingdom',
          role: 'Formerly City Traders Imperium Limited and City Traders Imperium Academy Limited. Renamed in January 2025 and subject to a voluntary strike-off application filed in March 2026; not the current disclosed program operator.',
        },
      ],
      regulatoryStatus: [
        'Current terms state all accounts are simulated demo accounts, no live capital is traded and CTI FZCO provides no investment service, brokerage, custody or client-money activity.',
        'Evaluation fees are described as service or test fees rather than deposits, so normal brokerage-account and investor-compensation protections are not documented.',
        'Current terms apply UAE law and give UAE courts exclusive jurisdiction for disputes.',
        'Successful evaluation clients may, at CTI FZCO sole discretion, be invited to a separate agreement with a third-party regulated broker called City Traders Imperium Limited; the terms do not provide a regulator number for that separate path.',
        'Finance Magnates reported that the Comoros structure supported direct MT5 access and should not be read as evidence of top-tier retail broker protection.',
      ],
      complaintsAndDisputes: [
        'Current terms permit account review, source-code requests, leverage reduction, a 1% max-risk limit, service cancellation and reward forfeiture for prohibited or risk-intolerable behaviour.',
        'The agreement allows suspension or termination without prior notice and gives the company broad discretion to refuse future service or re-entry.',
        'Finance Magnates reported complaints from traders whose accounts were breached after stop losses in roughly the 2.5% to 5.6% range; CTI said this reflected a disclosed overleveraging policy rather than a hidden rule.',
        'Trustpilot showed 4.3/5 from 1,691 reviews at this check, with a large positive majority but also recent complaints about platform closures, trailing drawdown and profitable-day requirements.',
      ],
      redFlags: [
        'Current sales pages use live-capital language for Instant Funding while the binding evaluation terms say every account is simulated and no live capital is traded.',
        'The legal path changed across the former UK company, a Comoros entity and the current UAE operator; the entity on checkout, invoice and accepted terms must match the intended program.',
        'Broad sole-discretion clauses can affect account status and reward eligibility even when headline drawdown limits appear simple.',
        'Up to 100% profit share and on-demand payout claims apply only at specific levels or VIP tiers, not uniformly from the first account stage.',
      ],
      sources: [
        { label: 'CTI September 2025 Evaluation Terms', url: 'https://citytradersimperium.com/wp-content/uploads/2025/09/CTI-FZCO-City-Traders-Imperium-Terms-Conditions.pdf' },
        { label: 'CTI April 2025 Terms naming the Comoros structure', url: 'https://citytradersimperium.com/wp-content/uploads/2025/04/City-Traders-Imperium-Terms-and-Conditions.pdf' },
        { label: 'CTI official program comparison', url: 'https://citytradersimperium.com/compare-funding-programs/' },
        { label: 'Companies House filing history for company 11463147', url: 'https://find-and-update.company-information.service.gov.uk/company/11463147/filing-history' },
        { label: 'Finance Magnates on the Comoros entity and in-house MT5', url: 'https://www.financemagnates.com/forex/prop-firm-city-traders-imperium-opens-offshore-comoros-entity-to-launch-in-house-mt5/' },
        { label: 'Finance Magnates June 2026 CTI interview', url: 'https://www.financemagnates.com/forex/some-of-them-wont-be-around-in-six-months-city-traders-imperium-ceo-says-of-cheaper-rivals/' },
        { label: 'Trustpilot City Traders Imperium', url: 'https://www.trustpilot.com/review/citytradersimperium.com' },
      ],
    },
    reviewSignals: {
      trustpilotReviewCount: 1691,
      trustpilotSourceUrl: 'https://www.trustpilot.com/review/citytradersimperium.com',
      trustpilotFlags: [
        'Claimed profile with a paid Trustpilot subscription and active review invitations.',
        'Recent review sample includes both verified positive service feedback and negative rule or platform complaints.',
      ],
      payoutIncidentCount: 1,
      payoutIncidentStatus: 'Watchlist',
      payoutIssues: [
        'Reward eligibility depends on the exact program, profitable-day requirement, KYC and conduct review.',
        'Overleveraging and prohibited-method enforcement can lead to account cancellation or reward forfeiture.',
      ],
      lastSignalCheck: '2026-07-12',
    },
  }),
  firm({
    id: 21,
  ...
  firm({
    ...
    newsTrading: 'Variable',
    eaAllowed: 'Variable',
    payoutDelay: 'variable via partners',
    incidents: 1,
    transparencyScore: 16,
    payoutProof: true,
    recentRuleChange: true,
    ...
    products: [
      product({
        ...
        profitSplit: '50/50 below the account threshold, 80/20 at or above it; fixed 60/40 on the $400k TCP account',
        platforms: ['NinjaTrader', 'Finamark', 'Rithmic'],
        tradableAssets: ['Futures'],
        minTradingDays: 'No explicit minimum for new purchases from 6 July 2026; the 30% consistency rule still requires multiple profitable days in practice',
        hasConsistencyRule: true,
        consistencyRule: 'The best trading day must remain below 30% of total evaluation profit.',
        linkToStart: 'https://www.earn2trade.com/',
      }),
    ],
    auditStatus: 'Partiellement vérifié',
    auditSummary:
      'Official Terms, partner disclosures and the 6 July 2026 evaluation-rule update checked against independent futures-industry coverage. Earn2Trade removed its explicit ten-day minimum for new purchases, retained a 30% consistency rule and introduced a tiered profit split. Earn2Trade, LLC remains a service/evaluation provider rather than a broker-dealer; funded progression depends on partner entities and the selected program.',
    auditSourcesChecked: ['Official site', 'Terms and Conditions', '6 July 2026 official rule update', 'Official partner disclosures', 'The Front Month independent coverage'],
    regulatoryAudit: {
      riskLevel: 'Medium',
      lastChecked: '2026-07-13',
      summary:
        'Medium legal risk. Earn2Trade clearly names its US company and disclaims broker-dealer status, but the purchase is service/evaluation access rather than a protected brokerage deposit. Rules changed on 6 July 2026: the explicit minimum-day requirement was removed for new purchases, while the 30% consistency rule and a tiered payout split remain material. The funded route and contract must be matched to the disclosed partner.',
      entities: [
        {
          name: 'Earn2Trade, LLC',
          jurisdiction: 'United States',
          registeredAddress: '30 N Gould St, Suite 4000, Sheridan, Wyoming 82801, United States',
          role: 'Company named in the official Terms and Conditions and partner page as operator of the site and evaluation services.',
        },
      ],
      regulatoryStatus: [
        ...
        'The official 6 July 2026 update removes the explicit ten-day minimum for new purchases, retains a 30% consistency rule and changes the profit split to a tiered model.',
        'Independent futures-industry publication The Front Month reported the same rule change and warned that third-party rule trackers may be stale.',
        'Earn2Trade publishes the firms involved in its funded-account path on a dedicated partner page.',
      ],
      complaintsAndDisputes: [
        ...
        'The exact profit split now depends on withdrawal amount, so the current threshold table should be saved before purchase.',
      ],
      redFlags: [
        ...
        'Older reviews and comparison pages may still show the pre-6 July 2026 minimum-day and payout rules.',
      ],
      sources: [
        ...
        { label: 'Earn2Trade evaluation rules and profit-split update, 6 July 2026', url: 'https://www.earn2trade.com/blog/earn2trade-evaluation-rules-profit-split-update/' },
        { label: 'Earn2Trade funded-account partners', url: 'https://www.earn2trade.com/partners' },
        { label: 'The Front Month: Earn2Trade drops minimum days', url: 'https://thefrontmonth.com/articles/2026-07-06-earn2trade-drops-minimum-days/' },
      ],
    },
    sources: [
      { label: 'Official Earn2Trade site', url: 'https://www.earn2trade.com/' },
      { label: 'Earn2Trade Terms and Conditions', url: 'https://www.earn2trade.com/terms-and-conditions' },
      { label: 'Earn2Trade rule update, 6 July 2026', url: 'https://www.earn2trade.com/blog/earn2trade-evaluation-rules-profit-split-update/' },
      { label: 'The Front Month independent rule-change coverage', url: 'https://thefrontmonth.com/articles/2026-07-06-earn2trade-drops-minimum-days/' },
    ],
  }),
  firm({
    id: 27,
  ...
  firm({
    ...
    auditStatus: 'Partiellement vérifié',
    auditSummary:
      'Official homepage, Terms and Refund Policy rechecked against a dated recovery timeline. Finance Magnates documented the March 2024 pause, an incomplete-looking April return, partial recovery claims in August and roughly 900 traders still awaiting payouts in November 2024. The current site identifies The Funded Trader LLC and fully simulated accounts. PropRadar separates current offers from legacy obligations because no independent public reconciliation proves that every pre-pause payout, affiliate balance and paused account was resolved.',
    auditSourcesChecked: ['Official homepage and current Terms', 'Refund Policy and FAQ', 'Finance Magnates April relaunch check', 'Finance Magnates August recovery report', 'Finance Magnates November payout-backlog report'],
    regulatoryAudit: {
      riskLevel: 'Critical',
      ...
      regulatoryStatus: [
        ...
        'Finance Magnates documented the March 2024 interruption and recovery claims through November 2024.',
      ],
      complaintsAndDisputes: [
        ...
        'No independent public reconciliation proving that every pre-pause payout, affiliate balance and account-restoration claim was resolved was captured.',
      ],
      redFlags: [
      ...
      sources: [
        ...
        { label: 'Finance Magnates April 2024 operational check', url: 'https://www.financemagnates.com/forex/prop-trading-firm-the-funded-trader-is-online-but-is-it-fully-operational/' },
        { label: 'Finance Magnates August 2024 recovery update', url: 'https://www.financemagnates.com/forex/prop-trading-the-funded-trader-resurfaces-five-months-after-pausing-operations/' },
        { label: 'Finance Magnates November 2024 payout-backlog report', url: 'https://www.financemagnates.com/forex/prop-firm-the-funded-trader-resumes-paused-accounts-as-900-traders-await-payouts/' },
      ],
    },
    sources: [
      { label: 'The Funded Trader official site', url: 'https://thefundedtraderprogram.com/' },
  ...
  firm({
    ...
    founded: 2020,
    headquarters: 'Canada',
    bestFor: 'inactive legal-relaunch case study',
    verdict: 'The US case was dismissed and most Ontario assets were released, but no fully audited active offer is verified yet.',
    priceFrom: 0,
    profitSplit: 0,
    drawdownType: 'Hybride',
    ...
    communitySignal: 'Legal status improved materially; operational readiness and legacy claims remain separate questions.',
    lastReviewed: '2026-07-19',
    reviewSignals: {
      redditScore: 8,
      redditMentions: 'shutdown history, legal-case updates, relaunch discussion and legacy trader claims',
      redditSignal: 'Négatif',
      redditFlags: ['Regulatory action', 'Crisis archives', 'Misleading historical popularity'],
      trustpilotReliabilityScore: 12,
      trustpilotReliability: 'Faible',
      trustpilotNote: 'Historical ratings cannot establish the status of a future relaunch or settle legacy claims.',
      trustpilotFlags: ['Historical reviews do not audit a relaunch', 'Current program still unverified', 'Legal outcome and operational readiness are different'],
      ...
      payoutIncidentStatus: 'Critique',
      payoutIssues: [
        'No normal current checkout and payout agreement verified.',
        'Legacy payout, refund and customer claims are not resolved by the US dismissal alone.',
        'A future launch requires a new program-level and jurisdiction audit.',
      ],
      confidenceDrivers: ['US case outcome verified', 'Ontario asset-release reporting captured', 'Current Terms checked'],
      radarVerdict: 'Relaunch watch: the legal picture changed, but no purchase recommendation is justified without live terms and payout mechanics.',
      lastSignalCheck: REVIEW_DATE,
    },
    products: [],
    strengths: ['US case dismissal verified', 'Current Terms available', 'Ontario asset-release development independently reported'],
    weaknesses: ['No audited active checkout', 'Legacy claims remain a separate file', 'Current program and jurisdiction coverage unverified'],
    auditStatus: 'Partiellement vérifié',
    auditSummary:
      'Legal-status pass updated July 19, 2026. The US federal complaint was dismissed with prejudice in May 2025 through case-ending sanctions tied to CFTC litigation misconduct. The CFTC Acting Chairman publicly addressed those findings. Bloomberg reported in December 2025 that an Ontario court returned access to nearly all funds and client data. Current Terms dated January 28, 2026 remain cautious about excluded countries and investor-protection coverage. PropRadar now treats the brand as an inactive relaunch watch, not a normal active buying option.',
    auditSourcesChecked: ['Current official site and Terms', 'CFTC Acting Chairman statement', 'Special Master report', 'Finance Magnates legal report', 'Bloomberg Ontario court report'],
    regulatoryAudit: {
      riskLevel: 'Critical',
      lastChecked: '2026-07-19',
      summary:
        'Critical but materially changed legal file. The US enforcement case ended through dismissal with prejudice and sanctions against the CFTC, while later Ontario asset-release reporting made a restart more plausible. That does not verify a live product, resolve every legacy customer question or establish current regulatory protection. Any relaunch must be audited from zero at program level.',
      entities: [
        {
      ...
      regulatoryStatus: [
        'The US federal complaint was dismissed with prejudice in May 2025 through case-ending sanctions related to CFTC litigation misconduct.',
        'The CFTC Acting Chairman publicly addressed the court findings against agency conduct.',
        'Bloomberg reported in December 2025 that the Ontario Superior Court returned access to nearly all funds and client data.',
        ...
        'No normal active product agreement and checkout were verified during this pass.',
      ],
      complaintsAndDisputes: [
        'Historical shutdown/regulatory-action risk overrides old review scores and old payout testimonials.',
        'The US dismissal ends that complaint but does not independently reconcile every payout, refund or legacy customer balance.',
      ...
      redFlags: [
        'Major historical regulator-action case with a materially changed legal outcome.',
        'Current site says it is informational and not a regulated/securities-authorized offer.',
        'A possible relaunch can be mistaken for an already verified operating product.',
      ],
      sources: [
        ...
        { label: 'CFTC Special Master report and recommendation', url: 'https://www.cftc.gov/media/12106/ogc_KazmiReportRecommendationSactions051325/download' },
        { label: 'CFTC Acting Chairman statement on court sanctions', url: 'https://www.cftc.gov/PressRoom/PressReleases/9074-25' },
        { label: 'Finance Magnates dismissal and sanctions report', url: 'https://www.financemagnates.com/forex/my-forex-funds-parent-defeats-cftc-in-court-as-judge-imposes-sanctions/' },
        { label: 'Bloomberg Ontario asset-release report', url: 'https://www.bloomberg.com/news/articles/2025-12-08/simulated-trading-firm-myforexfunds-clears-legal-hurdle-to-restart' },
      ],
    },
    sources: [
      { label: 'Current MyForexFunds site', url: 'https://myforexfunds.com/' },
  ...
  firm({
    ...
    auditStatus: 'Partiellement vérifié',
    auditSummary:
      'Closure timeline updated July 19, 2026. Finance Magnates documented Match-Trade Technologies terminating the platform relationship after a compliance procedure and SurgeTrader disputing that decision. A second report documented SurgeTrader announcing that it had closed and ceased all operations on May 24, 2024. The former domain is now parked for sale, with no active legal terms, support route or payout process.',
    auditSourcesChecked: ['Current parked domain', 'Finance Magnates platform-termination report', 'Finance Magnates closure report', 'Trustpilot history', 'Stale-domain classification'],
    regulatoryAudit: {
      riskLevel: 'Critical',
      lastChecked: '2026-07-19',
      summary:
      ...
      regulatoryStatus: [
        'Match-Trade Technologies told Finance Magnates that it terminated the cooperation following a compliance procedure and formal-requirements concerns; SurgeTrader disputed the decision.',
        'SurgeTrader announced definitive closure and cessation of all operations on May 24, 2024.',
      ...
      sources: [
        ...
        { label: 'Finance Magnates Match-Trader termination report', url: 'https://www.financemagnates.com/forex/exclusive-match-trader-terminates-prop-firm-surgetraders-license/' },
        { label: 'Finance Magnates SurgeTrader closure report', url: 'https://www.financemagnates.com/forex/prop-firm-surgetrader-shuts-down-a-week-after-losing-match-trader-license/' },
      ],
    },
    sources: [
      { label: 'Former SurgeTrader domain / Afternic parked page', url: 'https://surgetrader.com/' },
  ...
  firm({
    ...
    auditStatus: 'Partiellement vérifié',
    auditSummary:
      'Closure timeline updated July 19, 2026. FX News Group documented the February 2024 MetaTrader-license interruption and the May 14, 2024 permanent insolvency closure. Finance Magnates documented an attempted cTrader restart between those events. The current closure page remains the decisive operational signal. The CFTC RED List context is recorded as a registration warning, not as a court finding of a violation.',
    auditSourcesChecked: ['Current official closure page', 'FX News Group platform-loss report', 'Finance Magnates cTrader relaunch report', 'FX News Group insolvency report', 'CFTC RED List context'],
    regulatoryAudit: {
      riskLevel: 'Critical',
      lastChecked: '2026-07-19',
      summary:
      ...
      regulatoryStatus: [
        'FX News Group reported that MetaQuotes terminated the firm MT4 and MT5 licenses in February 2024.',
        'Finance Magnates documented an attempted cTrader relaunch later that month.',
        ...
        'True Forex Funds appeared on the CFTC RED List; the CFTC states that list inclusion is not itself a finding that a legal violation occurred.',
      ...
      sources: [
        ...
        { label: 'CFTC RED List and explanatory note', url: 'https://www.cftc.gov/LearnAndProtect/Resources/Check/redlist.htm' },
        { label: 'FX News Group MetaTrader interruption report', url: 'https://fxnewsgroup.com/forex-news/retail-forex/exclusive-prop-trading-firm-true-forex-funds-shut-down-by-metaquotes-move/' },
        { label: 'Finance Magnates cTrader relaunch report', url: 'https://www.financemagnates.com/forex/true-forex-funds-revives-operations-with-ctrader-platform/' },
        { label: 'FX News Group permanent insolvency closure', url: 'https://fxnewsgroup.com/forex-news/retail-forex/prop-firm-true-forex-funds-folds/' },
      ],
    },
    sources: [
      { label: 'True Forex Funds official closure page', url: 'https://trueforexfunds.com/' },
...
const universePropFirms: PropFirm[] = [
  ...
  universeFirm({
    ...
    commercialRelationship: 'Affiliation transparente',
    commercialNote:
      'PropRadar may receive a commission through the FunderPro link. Partner code PROPRADAR had no public percentage confirmed on 13 July 2026; documented alternatives include the automatic 15% Pro offer, NOMINDAYS and AWARD200. The relationship has no impact on the score.',
    auditStatus: 'Partiellement vérifié',
    auditSummary:
  ...
  universeFirm({
    ...
    auditStatus: 'Vérifié multi-source',
    auditSummary:
      'Official Axi Select/legal documentation and Finance Magnates launch and first-year coverage checked. Axi Select is a broker-linked capital-allocation program rather than a paid demo challenge: the trader first uses an Axi account and may then qualify for allocation. Current legal pages identify AxiTrader LLC in Saint Vincent and the Grenadines, while launch-era coverage named AxiTrader Limited; the current checkout entity and regional eligibility therefore matter.',
    auditSourcesChecked: ['Axi Select official page', 'Axi legal documentation', 'Finance Magnates 2023 launch coverage', 'Finance Magnates 2024 first-year coverage', 'Axi Trustpilot'],
    regulatoryAudit: {
      riskLevel: 'Medium',
      lastChecked: '2026-07-13',
      summary:
        'Medium regulatory risk. Axi Select is tied to an established broker brand, but the international program is offered through the Saint Vincent and the Grenadines route and is materially different from a free prop challenge. Users trade through an Axi account, maintain minimum equity and face normal CFD trading risk before any allocation. Historical coverage and the current footer use different Axi entity names, so the contract and region shown at checkout control.',
      entities: [
        {
          name: 'AxiTrader LLC',
      ...
      regulatoryStatus: [
        'Official Axi legal page says AxiTrader LLC is incorporated in Saint Vincent and the Grenadines and registered by the Financial Services Authority; company registration should not be read as equivalent to top-tier brokerage supervision or client protection.',
        ...
        'Finance Magnates reported at launch that Axi framed Select as capital allocation rather than prop trading and offered it without an evaluation registration fee.',
        'Finance Magnates reported in 2024 that the program was unavailable in Australia, New Zealand, the European Union and the United Kingdom at that time; current restrictions must be rechecked.',
      ],
      complaintsAndDisputes: [
        'Use broker complaints handling and legal documentation, not only prop-firm review sites, when evaluating disputes.',
        'Confirm which Axi legal entity holds the account and which complaints process applies in the trader\'s country.',
      ],
      redFlags: [
        ...
        'Launch-era coverage named AxiTrader Limited, while current legal disclosure names AxiTrader LLC, registration 4303 LLC 2025.',
        'Historical regional exclusions should not be assumed unchanged without checking the current eligibility page.',
      ],
      sources: [
        ...
        { label: 'Finance Magnates: Axi Select launch and model', url: 'https://www.financemagnates.com/forex/90-profit-split-cfds-broker-axi-dives-into-prop-trading/' },
        { label: 'Finance Magnates: Axi Select first-year review', url: 'https://www.financemagnates.com/forex/prop-trading-axi-select-marks-one-year-attracting-over-17k-traders/' },
  ...
  universeFirm({
    ...
    additionalSources: [
      ...
      { label: 'Finance Magnates FPFX license-termination report', url: 'https://www.financemagnates.com/forex/breaking-fpfx-technologies-revokes-license-of-proprietary-trading-firm-funded-engineer/' },
      { label: 'Finance Magnates Blueberry close-only report', url: 'https://www.financemagnates.com/forex/blueberry-markets-sets-all-prop-trading-accounts-to-close-only/' },
      { label: 'Finance Magnates permanent-closure report', url: 'https://www.financemagnates.com/forex/breaking-prop-trading-firm-funded-engineer-shuts-down/' },
      { label: 'Funded Engineer Trustpilot', url: 'https://www.trustpilot.com/review/fundedengineer.com' },
    ],
    auditStatus: 'Partiellement vérifié',
    auditSummary:
      'Closure timeline updated July 19, 2026. Finance Magnates documented FPFX Technologies terminating its license and services in February 2024, later brokerage and close-only disruption, and Funded Engineer announcing permanent closure on July 15, 2024 with an intended bankruptcy filing. The closure notice did not specify a complete pending-payout process. The live domain still provides no usable current legal text.',
    auditSourcesChecked: ['Official domain reachability', 'Finance Magnates FPFX report', 'Finance Magnates broker-dependency report', 'Finance Magnates bankruptcy/closure report', 'Trustpilot history'],
    regulatoryAudit: {
      riskLevel: 'Critical',
      lastChecked: '2026-07-19',
      summary:
        'Critical closure and bankruptcy archive. The public timeline now documents technology-license loss, brokerage disruption and the July 15, 2024 permanent closure announcement. The former operator entity, any bankruptcy docket and the final payout/refund process still require archived legal records.',
      entities: [
        {
          name: 'Funded Engineer',
      ...
      regulatoryStatus: [
        'FPFX Technologies terminated its license and services agreement with Funded Engineer in February 2024.',
        'Brokerage changes and close-only account restrictions created an additional service interruption in March 2024.',
        'Funded Engineer announced permanent closure and an intended bankruptcy filing on July 15, 2024.',
      ...
      complaintsAndDisputes: [
        'The permanent-closure announcement did not specify how every pending payout or refund would be handled.',
  ...
  universeFirm({
    ...
    payoutProof: false,
    lastReviewed: '2026-07-19',
    note: 'Closed risk archive: operations and new purchases were suspended on March 28, 2024.',
    incidentsDetails: [
      'Skilled Funded Traders announced the immediate suspension of operations and new purchases on March 28, 2024.',
      'Finance Magnates reported payout-denial and trading-issue complaints around the shutdown period.',
      'Any unresolved trader compensation, refund or payout obligation must be reconstructed from archived records.',
    ],
    communitySignal: 'Historical reviews are secondary to the March 2024 closure notice and unresolved-obligation risk.',
    strengths: ['Useful closure archive', 'Shutdown documented by two financial-industry publications'],
    weaknesses: ['No current purchase candidate', 'Closed operations', 'Historical payout and refund obligations may remain unresolved'],
    additionalSources: [
      { label: 'Skilled Funded Traders terms URL to recheck manually', url: 'https://skilledfundedtraders.com/terms-and-conditions/' },
      { label: 'Finance Magnates report on the March 2024 shutdown', url: 'https://www.financemagnates.com/forex/easton-controlled-skilled-funded-trader-suspends-prop-trading-operations/' },
      { label: 'FX News Group report on the Skilled Funded Traders shutdown', url: 'https://fxnewsgroup.com/forex-news/retail-forex/skilled-funded-traders-becomes-second-easton-prop-firm-shut/' },
      { label: 'Skilled Funded Traders Trustpilot', url: 'https://www.trustpilot.com/review/skilledfundedtraders.com' },
    ],
    auditStatus: 'Partiellement vérifié',
    auditSummary:
      'Closure evidence rechecked July 19, 2026. Finance Magnates and FX News Group documented Skilled Funded Traders suspending operations and new purchases on March 28, 2024. The exact Easton-linked contracting structure and the final treatment of trader payouts or refunds still require archived primary documents.',
    auditSourcesChecked: ['Official domain and archived terms leads', 'Finance Magnates', 'FX News Group', 'Trustpilot history', 'Closed-risk archive classification'],
    regulatoryAudit: {
      riskLevel: 'Critical',
      lastChecked: '2026-07-19',
      summary:
        'Critical operational archive risk. Skilled Funded Traders is not a current purchase candidate: two financial-industry publications documented the March 28, 2024 shutdown. The remaining legal work is to reconstruct the contracting entity and any unresolved payout or refund obligations.',
      entities: [
        {
          name: 'Skilled Funded Traders',
          jurisdiction: 'Contracting jurisdiction to reconstruct from archived terms',
          role: 'Former prop-firm brand whose operations and new purchases were suspended in March 2024.',
        },
        {
          name: 'Easton-linked operating structure',
          jurisdiction: 'United States - exact entity relationship to verify',
          role: 'Finance Magnates reported Easton control; FX News Group described an affiliation while noting that the exact ownership or white-label relationship was unclear.',
        },
      ],
      regulatoryStatus: [
        'The March 28, 2024 operational suspension is documented by Finance Magnates and FX News Group.',
        'No active prop-firm product should be inferred from old search results, forex pages, stocks pages or historical reviews.',
        'The former contracting entity and any applicable dispute venue still need archived terms or company records.',
      ],
      complaintsAndDisputes: [
        'Finance Magnates reported payout-denial and trading-issue complaints around the shutdown period.',
        'PropRadar has not found a sufficiently strong public record proving that every historical payout, refund or compensation issue was resolved.',
      ],
      redFlags: [
        'Operations and new purchases were suspended in March 2024.',
        'Old product pages or third-party reviews can create a false impression of a current offer.',
        'The exact Easton-linked legal relationship remains partly unresolved in public reporting.',
        'Historical trader obligations require archived evidence rather than current marketing pages.',
      ],
      sources: [
