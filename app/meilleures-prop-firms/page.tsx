...
export const metadata: Metadata = {
  ...
  description:
    'Classement PropRadar des prop firms les plus solides : score, prix, payout, Trustpilot filtré, Reddit et transparence commerciale.',
  alternates: {
  ...
  return (
    <main className="container guide-page">
      <section className="guide-hero">
        <div>
          <div className="eyebrow">Guide décision</div>
          ...
          <p className="lead">
            ...
            risque payout, les avis filtrés, les sources et la transparence commerciale.
          </p>
        ...
        <div className="guide-proof-panel">
          ...
          <div><strong>{shortlist.length}</strong><span>profils solides affichés ici</span></div>
      ...
      <section className="section">
        <div className="section-heading">
          <div>
            ...
            <h2>Top firms à comparer en premier</h2>
          </div>
        </div>
      ...
      <section className="section guide-card-grid">
        <article className="panel">
          ...
          <ul className="risk-list">
            <li>Une bonne note publique ne suffit pas si les payouts sont contestés.</li>
            <li>Une promo ne compense pas une règle de drawdown ou consistency dangereuse.</li>
            <li>Une affiliation reste visible et ne protège pas le score.</li>
            <li>Les firms fermées ou à surveiller restent dans le radar pour éviter les angles morts.</li>
          </ul>
        </article>
        <article className="panel">
