...
export const metadata: Metadata = {
  title: 'Prop firm Trustpilot reviews: how to verify them',
  description:
    'PropRadar separates raw Trustpilot ratings from verified reliability: volume, review alerts, payout incidents, legal checks, source depth and community consistency.',
  alternates: {
